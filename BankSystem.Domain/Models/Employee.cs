...
public class Employee : Person
{
    ...
    public string Contract
    {
        ...
        {
            return
                $"Contract for {Name} {Surname} from {StartDate.ToString("d")} to {EndDate.ToString("d")} with salary: {Salary}";
        }
        set { }
    }
    ...
    public override int GetHashCode()
    {
        return HashCode.Combine(
            ...
            HashCode.Combine(Age, Address, Position, Salary, StartDate, EndDate)
        );
    }
}