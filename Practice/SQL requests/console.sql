...
insert into Employees values
                          (default, 'Игорь', 'Соловьев', '+79003456790', 'igor.solovyev@example.com', 36, 'Москва, ул. Кутузова, д. 15', '1234 567900', '1987-04-02', 100.00, 'Менеджер', '2023-01-01', '2024-01-01', 60000.00, 'RUB'),
                          (default, 'Светлана', 'Михайлова', '+79001239877', 'svetlana.mikhailova@example.com', 30, 'Санкт-Петербург, ул. Ломоносова, д. 25', '1234 567901', '1993-02-20', 150.00, 'Директор', '2022-03-15', '2023-03-15', 90000.00, 'RUB'),
                          (default, 'Павел', 'Романов', '+37377604980', 'pavel.romanov@example.com', 40, 'Бендеры, ул. Гагарина, д. 10', '1234 567902', '1983-08-30', 200.00, 'Инженер', '2021-05-05', '2023-05-05', 750.00, 'USD'),
                          (default, 'Алина', 'Григорьева', '+79009876545', 'alina.grigorieva@example.com', 28, 'Казань, ул. Гагарина, д. 4', '1234 567903', '1995-11-15', 80.00, 'Маркетолог', '2022-06-10', '2023-06-10', 55000.00, 'RUB'),
                          (default, 'Николай', 'Дмитриев', '+79003456791', 'nikolai.dmitriev@example.com', 50, 'Нижний Новгород, ул. Пушкина, д. 5', '1234 567904', '1973-01-20', 300.00, 'Аналитик', '2020-07-15', '2023-07-15', 80000.00, 'RUB'),
                          (default, 'Елена', 'Лаврова', '+37377608504', 'elena.lavrova@example.com', 34, 'Кишинев, ул. Чайковского, д. 2', '1234 567905', '1989-09-25', 90.00, 'Бухгалтер', '2021-08-20', '2023-08-20', 600, 'EUR'),
                          (default, 'Владимир', 'Сергеев', '+79004567892', 'vladimir.sergeev@example.com', 29, 'Челябинск, ул. Шевченко, д. 6', '1234 567906', '1994-05-30', 120.00, 'Системный администратор', '2022-02-15', '2023-02-15', 70000.00, 'RUB'),
                          (default, 'Кристина', 'Орлова', '+79009876546', 'kristina.orlova@example.com', 31, 'Самара, ул. Крылова, д. 1', '1234 567907', '1992-06-28', 95.00, 'Дизайнер', '2021-10-05', '2023-10-05', 60000.00, 'RUB'),
                          (default, 'Денис', 'Ковалев', '+79003456792', 'denis.kovalev@example.com', 42, 'Волгоград, ул. Пионеров, д. 3', '1234 567908', '1981-03-15', 110.00, 'Разработчик', '2020-09-20', '2023-09-20', 80000.00, 'RUB'),
                          (default, 'Людмила', 'Шевченко', '+37377503506', 'lyudmila.shevchenko@example.com', 39, 'Бендеры, ул. Ленина, д. 8', '1234 567909', '1984-12-12', 140.00, 'HR-менеджер', '2022-11-11', '2023-11-11', 500, 'USD');
